def readerHtml():
    htmlForm_path=r"C:\github-nangmanhunter\etc\in-progress\JavaScript\AutomationTool\00HtmlForm.html"
...
def createHtml(html,fileName):
    html_content=html
    file_path = rf"C:\github-nangmanhunter\etc\in-progress\JavaScript\Doc\html\{fileName}.html"  
...
def fileList():
    import os
    folder_path = r"C:\github-nangmanhunter\etc\in-progress\JavaScript\Doc"
